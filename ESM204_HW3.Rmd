...
demand_tax <- function(p, model, mec){
...
(a) This tax decreases the amount of electricity produced and consumed, the quantity of energy under the tax scenario is `r round(Qt, 2)` kWh.
...
5. Assuming that all revenue from the electricity tax will be redistributed to the consumers in
proportion to their pre-tax consumption high income 
Additionally, consider the fact that current scientific evidence suggests the true SCC may be much higher than $51. For
